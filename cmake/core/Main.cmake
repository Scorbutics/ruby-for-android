...
function(declare_application)
    ...
    message(STATUS "  Application:   ${ARG_APP_NAME}")
    if(NOT ARG_APP_VERSION STREQUAL "unknown")
        message(STATUS "  Version:       ${ARG_APP_VERSION}")
    endif()
    ...
    message(STATUS "  Dependencies:  ${ARG_APP_DEPENDENCIES}")
    message(STATUS "==========================================")
    message(STATUS "Build targets:")
    message(STATUS "  all           - Build everything (default)")
    message(STATUS "  clean-all     - Clean everything")
    message(STATUS "  clean-libs    - Clean all library builds")
    message(STATUS "  {dep}_clean   - Clean specific dependency")
    message(STATUS "==========================================")
endfunction()
